export function BannerInfo() {
  return (
    <section className="w-full z-20">
      ...
      <div className="inline-block py-2 px-4 rounded-full border-2 border-solid border-white">
        <p className="rounded-accent-font text-white uppercase text-[12px] md:text-[14px]">
          Rico is back!
        </p>
      </div>
      <h1 className="my-8 text-white uppercase text-[49px] md:[35px] ">
        ricobot
      </h1>
      <p className="description text-white text-[14px] md:text-[16px]">
